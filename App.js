  ...
  render() {
    ...
    if (this.state.exercise.answers.length === 7 && this.state.exercise.answers[6] !== '') {
      if (this.state.editing) {
        lastButton = (
          <TouchableOpacity style={styles.finishExerciseButton} onPress={() => this.next(6)}>
            <Text style={styles.finishExerciseButtonText}>SAVE</Text>
          </TouchableOpacity>
        );
      } else {
        lastButton = (
          <TouchableOpacity style={styles.finishExerciseButton} onPress={() => this.next(6)}>
            <Text style={styles.finishExerciseButtonText}>FINISH</Text>
          </TouchableOpacity>
        );
      }
    }
      ...
      <View style={styles.app}>
        <ScrollView>
                ...
                return (
                  <View style={styles.answerContainer} key={index}>
                    <View style={styles.answerContent}>
                      <View style={styles.answerPropmt}>
                      ...
                      <View style={styles.answer}>
                        <TextInput
                          ...
                          onChangeText={text => this.changeAnswer(text, index)}
                          onFocus={() => this.setCurrent(index)}
                          returnKeyType="next"
          ...
          <View style={styles.past} ref="past">
            ...
            <TouchableHighlight style={styles.takeAgainButton} onPress={this.startExercise}>
              <Text style={styles.takeAgainButtonText}>START NEW EXERCISE</Text>
            </TouchableHighlight>
          </View>
          <View style={styles.share}>
            <View style={styles.shareTitleView}>
              <Text style={styles.shareTitle}>If you found this exercise useful,</Text>
              <Text style={styles.shareTitleMain}>Share It</Text>
            </View>
            <View style={styles.shareButtons}>
              <TouchableOpacity style={styles.shareButton} onPress={this.shareTwitter}>
                <FontAwesome name="twitter" color="#e85454" size={24} />
              </TouchableOpacity>
              <TouchableOpacity style={styles.shareButton} onPress={this.shareFacebook}>
                <FontAwesome name="facebook" color="#e85454" size={24} />
              </TouchableOpacity>
              <TouchableOpacity style={styles.shareButton} onPress={this.shareLinkedin}>
                <FontAwesome name="linkedin" color="#e85454" size={24} />
              </TouchableOpacity>
              <TouchableOpacity style={styles.shareButton} onPress={this.shareEmail}>
                <MaterialIcons name="email" color="#e85454" size={24} />
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              Made with <FontAwesome name="heart" color="#e85454" size={14} /> by{' '}
            </Text>
            <TouchableOpacity style={styles.myLink} onPress={this.openLink}>
              <Text style={styles.myLinkText}>Parker Klein</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
        <KeyboardSpacer />
